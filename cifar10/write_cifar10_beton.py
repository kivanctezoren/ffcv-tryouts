...
def main(train_dataset, val_dataset):
    datasets = {
        'train': torchvision.datasets.CIFAR10('/home/ktezoren/ffcv/dsets', train=True, download=True),
        'test': torchvision.datasets.CIFAR10('/home/ktezoren/ffcv/dsets', train=False, download=True)
        }
